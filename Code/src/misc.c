...
{
	int fDataSec = boot_sector.reserved_sectors + (boot_sector.number_of_fats* boot_sector.bpb_FATSz32);
	return ((clus_num - 2 )*boot_sector.sectors_per_cluster) + fDataSec;		
}
